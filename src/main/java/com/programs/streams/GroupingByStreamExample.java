...
public class GroupingByStreamExample {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Long> singleFieldsMap = employeesList.stream()
                .collect(
                        Collectors.groupingBy(Employee::getGender,
                                Collectors.counting()));
        ...
        System.out.println("Group by on multiple properties" + singleFieldsMap);
        ...
        Map<String, Map<String, List<Employee>>> multipleFieldsMapList = employeesList.stream()
                .collect(
                        Collectors.groupingBy(Employee::getDesignation,
                                Collectors.groupingBy(Employee::getGender)));
        System.out.println("Group by on multiple properties " +
                " Collect Aggregated Result" + multipleFieldsMapList);
    }
}